...
import {createInvoice} from "@/app/_lib/service/invoice-service";
...
export default function CreateInvoiceFormByZod({customers}: { customers: CustomerField[] }) {
    const {
        register,
        handleSubmit,
        setError,
                ...
                <div className="mb-4">
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                            <input
                                id="amount"
                                {...register("amount", {required: "Please enter an amount", min: 0.01, max: 100000, valueAsNumber: true})}
                                type="number"
                                step="0.01"
